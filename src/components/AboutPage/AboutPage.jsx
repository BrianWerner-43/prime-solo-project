...
function AboutPage() {
  return (
    <div className="about-me">
      ...
      <br />
        <p className="about-ptag">So a little about me, I was a chef for a little over 20 years and I made the transition into the tech industry about a year ago. So I thought what better way to utilize these new skills that I've learned
